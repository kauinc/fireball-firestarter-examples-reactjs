...
/**
 * HISTORY + Hats / Glasses + POSITION(S).
 * Frame = frame Position bar; fill = scroll Position bar up to max choice;
 * Scroll button pointer sits on the fill's right edge, inside the frame.
 */
